...
class IdentifyVerdictTest {
    ...
    private fun verdict(bound: TagSummary?, chip: IdentifiedChip?, read: ChipRead = chip?.let { ChipRead.Url(url) } ?: ChipRead.Blank) =
        identifyVerdict(IdentifyResponse(uid, bound, chip), read)
