...
/**
 * The real writer: drives an NTAG 424 DNA chip through [ChipSequence] over [IsoDep], with the
 * server calls from [AdminApi]. All chip logic lives in [ChipSequence] so it can be unit tested
 * without Android.
 */
